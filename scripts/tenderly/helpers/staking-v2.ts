...
export const createV1EscrowEntries = async ({
    ...
    await sendTransaction({
        contractName: "DexToro",
        contractAddress: OPTIMISM_DTORO_TOKEN,
...
export const deployRewardEscrowV2 = async (
    ...
    await deployUUPSProxy({
        ...
        constructorArgs: [OPTIMISM_DTORO_TOKEN, rewardsNotifier],
...
export const simulateMigration = async ({
    ...
    const dextoro = await ethers.getContractAt("DexToro", OPTIMISM_DTORO_TOKEN);
    ...
    await sendTransaction({
        contractName: "DexToro",
        contractAddress: dextoro.address,
        functionName: "approve",
