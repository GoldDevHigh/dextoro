...
async function main() {
    // addresses eligible for DTORO distribution
...
function logFindings(
    ...
    // log total number of *eligible for DTORO* addresses that are:
    // (1) whitelisted
    // (2) blacklisted
    // (3) neither
    console.log(
...
function logMultisigs(multisig: string[]) {
    console.log('### ALL MULTISIG ADDRESSES IN DTORO DISTRIBUTION ###');
