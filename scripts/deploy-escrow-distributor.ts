...
import dextoroTestnetDeploy from "../deployments/optimistic-goerli/DexToro.json";
...
async function main() {
    ...
    await verify(
        ...
        [dextoroTestnetDeploy.address, rewardEscrowTestnetDeploy.address],
