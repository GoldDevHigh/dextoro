...
contract TokenDistributorTest is TokenDistributorSetup {
    ...
    function setUp() public override {
        ...
        super.setUp();
        vm.prank(treasury);
        dextoro.transfer(address(this), 100_000 ether);
    }
    ...
    function testCheckpointToken() public {
        dextoro.transfer(address(tokenDistributor), 10);
        dextoro.transfer(address(user1), 1);
        vm.startPrank(address(user1));
        dextoro.approve(address(stakingRewardsV2), 1);
    ...
    function testClaimEpoch3People() public {
        ...
        dextoro.transfer(address(user2), 1);
        vm.startPrank(address(user2));
        dextoro.approve(address(stakingRewardsV2), 1);
        stakingRewardsV2.stake(1);
        vm.stopPrank();

        dextoro.transfer(address(user3), 3);
        vm.startPrank(address(user3));
        dextoro.approve(address(stakingRewardsV2), 3);
        ...
        dextoro.transfer(address(tokenDistributorOffset), 10);
    ...
    function testClaimEpochCheckpoint() public {
        ...
        stakingRewardsV2.stake(1);
        vm.stopPrank();
        dextoro.transfer(address(user2), 2);
        vm.startPrank(address(user2));
        dextoro.approve(address(stakingRewardsV2), 2);
        ...
        tokenDistributor.checkpointToken();
        dextoro.transfer(address(tokenDistributor), 5);
        goForward(4801);
    ...
    function testCalculateEpochFees() public {
        ...
        goForward(304_801);
        dextoro.transfer(address(tokenDistributor), 1000);
        tokenDistributor.checkpointToken();
        goForward(1 weeks);
    ...
    function testFuzzCalculateEpochFees(uint256 amount) public {
        ...
        goForward(0.5 weeks);
        dextoro.transfer(address(tokenDistributor), amount);
        ...
        public
    {
        ...
        dextoro.transfer(address(user1), staking1);
        dextoro.transfer(address(user2), staking2);
        vm.startPrank(address(user1));
        dextoro.approve(address(stakingRewardsV2), staking1);
        stakingRewardsV2.stake(staking1);
        vm.stopPrank();
        vm.startPrank(address(user2));
        dextoro.approve(address(stakingRewardsV2), staking2);
    ...
    function testClaimMultipleClaims() public {
        ...
        tokenDistributor.claimEpoch(address(user1), 1);
        dextoro.transfer(address(tokenDistributor), 5000);
        ...
        goForward(1000);
        dextoro.transfer(address(tokenDistributor), 300);
        vm.prank(user2);
        vm.expectEmit(true, true, false, true);
    ...
    function testFuzzTimeClaimWithRandomStart(
        ...
        goForward(time);
        dextoro.transfer(address(tokenDistributorRandom), amount);
    ...
    function testOffset() public {
        ...
        goForward(2 days);
        dextoro.transfer(address(tokenDistributorOffset), 100);
        ...
        tokenDistributorOffset.checkpointToken();
        dextoro.transfer(address(tokenDistributorOffset), 5);
        goForward(4801);
    ...
    function testFuzzFeesOffset(uint256 amount) public {
        ...
        goForward(2 days);
        tokenDistributorOffset.checkpointToken();
        dextoro.transfer(address(tokenDistributorOffset), amount);
    ...
    function testFuzzStakingOffset(
        ...
        dextoro.transfer(address(user3), staking3);
        vm.startPrank(address(user3));
        dextoro.approve(address(stakingRewardsV2), staking3);
