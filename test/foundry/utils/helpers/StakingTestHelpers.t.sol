...
contract StakingTestHelpers is StakingV2Setup {
    ...
    function createRewardEscrowEntryV1(address _account, uint256 _amount) internal {
        vm.prank(treasury);
        dextoro.approve(address(rewardEscrowV1), _amount);
        vm.prank(treasury);
    ...
    function addNewRewardsToStakingRewardsV1(uint256 _reward) internal {
        vm.prank(treasury);
        dextoro.transfer(address(stakingRewardsV1), _reward);
    ...
    function fundAndApproveAccountV1(address _account, uint256 _amount) internal {
        ...
        vm.prank(_account);
        dextoro.approve(address(stakingRewardsV1), _amount);
    }
    ...
    function addNewRewardsToStakingRewardsV2(uint256 _reward) internal {
        vm.prank(treasury);
        dextoro.transfer(address(stakingRewardsV2), _reward);
    ...
    function fundAndApproveAccountV2(address _account, uint256 _amount) internal {
        ...
        dextoro.transfer(_account, _amount);
        vm.prank(_account);
        dextoro.approve(address(stakingRewardsV2), _amount);
    }
    ...
    function bulkCreateV1EscrowEntries(address _account, uint256 _amount, uint256 num) internal {
        ...
        dextoro.approve(address(rewardEscrowV1), _amount * num);
    ...
    function createRewardEscrowEntryV2(address _account, uint256 _amount) internal {
        vm.prank(treasury);
        dextoro.approve(address(rewardEscrowV2), _amount);
        vm.prank(treasury);
    ...
    function appendRewardEscrowEntryV2(address _account, uint256 _amount) internal {
        vm.prank(treasury);
        dextoro.transfer(address(rewardEscrowV2), _amount);
