...
contract StakingV2MigrationForkTests is StakingTestHelpers {
    ...
    function test_Migrate_Then_Move_Funds_From_V1_To_V2_And_Generate_New_Rewards() public {
        ...
        uint256 initialBalance = dextoro.balanceOf(user1);
        ...
        assertEq(dextoro.balanceOf(user1), initialBalance + user1NonEscrowStakedV1);
        ...
        // stake funds with v2
        stakeFundsV2(user1, dextoro.balanceOf(user1));
    ...
    function test_Can_Vest_After_Migration() public {
        ...
        assertGt(dextoro.balanceOf(user2), 0);
    ...
    function test_Cannot_Vest_If_Treasury_Transfer_Fails() public {
        ...
        uint256 rewardEscrowV2Balance = dextoro.balanceOf(address(rewardEscrowV2));
        vm.prank(address(rewardEscrowV2));
        dextoro.transfer(address(user1), rewardEscrowV2Balance);
    ...
    function test_Cannot_Vest_If_Vested_Tokes_Transfer_Fails() public {
        ...
        uint256 rewardEscrowV2Balance = dextoro.balanceOf(address(rewardEscrowV2));
        vm.prank(address(rewardEscrowV2));
        dextoro.transfer(address(user1), rewardEscrowV2Balance - 1 ether);
