...
contract StakingV2MigrationForkTests is EscrowMigratorTestHelpers {
    ...
    function setUp() public virtual override {
        ...
        dextoro = DexToro(OPTIMISM_DTORO_TOKEN);
        ...
        assertEq(dextoro.balanceOf(address(stakingRewardsV2)), 0);
        ...
        assertGt(dextoro.balanceOf(address(stakingRewardsV2)), 0);
    ...
    function test_Payment_Cost_Takes_Account_Of_Escrow_Vested_At_Start() public {
        ...
        vm.prank(treasury);
        dextoro.transfer(user3, 50 ether);
    ...
    function test_Step_3_Must_Pay_Fuzz(uint256 approveAmount) public {
        ...
        vm.prank(user1);
        dextoro.approve(address(escrowMigrator), approveAmount);
    ...
    function test_Cannot_Migrate_Non_Vested_Entries() public {
        ...
        vm.prank(treasury);
        dextoro.transfer(address(escrowMigrator), 50 ether);
    ...
    function test_Cannot_Duplicate_Migrate_Entries() public {
        ...
        vm.prank(treasury);
        dextoro.transfer(address(escrowMigrator), 20 ether);
    ...
    function test_Migrator() public {
        ...
        uint256 step2UserBalance = dextoro.balanceOf(user1);
        uint256 step2MigratorBalance = dextoro.balanceOf(address(escrowMigrator));

        // step 2.1 - vest
        vm.prank(user1);
        rewardEscrowV1.vest(entryIDs);

        uint256 step2UserBalanceAfterVest = dextoro.balanceOf(user1);
        uint256 step2MigratorBalanceAfterVest = dextoro.balanceOf(address(escrowMigrator));
        ...
        vm.prank(user1);
        dextoro.approve(address(escrowMigrator), total);
    ...
    function test_Fund_Recovery_User_Regisered() public {
        ...
        uint256 userBalanceBeforeVest = dextoro.balanceOf(user1);
        uint256 escrowMigratorBalanceBeforeVest = dextoro.balanceOf(address(escrowMigrator));
        ...
        assertEq(escrowMigrator.totalRegistered(), 0);
        assertEq(escrowMigrator.totalMigrated(), 0);
        assertEq(dextoro.balanceOf(address(escrowMigrator)), fee);
        assertEq(dextoro.balanceOf(user1) - userBalanceBeforeVest, total);
        assertEq(dextoro.balanceOf(address(escrowMigrator)) - escrowMigratorBalanceBeforeVest, fee);
        ...
        uint256 balanceBefore = dextoro.balanceOf(treasury);

        vm.prank(owner);
        escrowMigrator.recoverExcessFunds();

        uint256 balanceAfter = dextoro.balanceOf(treasury);

        assertEq(balanceAfter - balanceBefore, fee - user3Total - user3Fee);
        assertEq(dextoro.balanceOf(address(escrowMigrator)), user3Total + user3Fee);
    ...
    function test_Fund_Recovery_Nothing_To_Recover() public {
        ...
        uint256 user1Balance = dextoro.balanceOf(user1);
        uint256 escrowMigratorBalance = dextoro.balanceOf(address(escrowMigrator));
        ...
        assertEq(escrowMigrator.totalRegistered(), 0);
        assertEq(escrowMigrator.totalMigrated(), 0);
        assertEq(dextoro.balanceOf(address(escrowMigrator)), 0);
        assertEq(dextoro.balanceOf(user1) - user1Balance, 0);
        assertEq(dextoro.balanceOf(address(escrowMigrator)) - escrowMigratorBalance, 0);
    ...
    function test_User_Regisered_Free_Frozen_Funds() public {
        ...
        vm.prank(owner);
        escrowMigrator.recoverExcessFunds();
        assertEq(dextoro.balanceOf(treasury), balanceAfter);
    }
    ...
    function test_Fund_Recovery_User_Registered_And_Vested() public {
        ...
        assertEq(escrowMigrator.totalMigrated(), escrowMigrator.totalEscrowRegistered(user2));
        assertEq(escrowMigrator.totalMigrated(), user2Total + user2Fee);
        assertEq(dextoro.balanceOf(address(escrowMigrator)), fee + user3Fee);
        assertEq(
            dextoro.balanceOf(address(escrowMigrator)) - escrowMigratorBalanceBeforeVest,
            fee + user3Fee
        );
    ...
    function test_Fund_Recovery_User_Migrated() public {
        ...
        assertEq(dextoro.balanceOf(address(escrowMigrator)), 0);
        assertEq(dextoro.balanceOf(treasury) - balanceBefore, fee);
