...
describe("MultipleMerkleDistributor", () => {
    ...
    describe("dextoro", () => {
        it("returns the token address", async () => {
            ...
            expect(await distributor.token()).to.equal(dextoro.address);
    ...
    describe("claim", () => {
        ...
        it("fails for invalid index", async () => {
            ...
            dextoro.connect(TREASURY_DAO).transfer(distributor.address, 100);
        ...
        describe("two account tree", () => {
            ...
            beforeEach("deploy", async () => {
                ...
                ).to.changeTokenBalance(dextoro, distributor, 201);
            });
            ...
            it("successful claim and transfer", async () => {
                ...
                expect(await dextoro.balanceOf(addr0.address)).to.equal(100);
                ...
                expect(await dextoro.balanceOf(addr1.address)).to.equal(101);

                expect(await dextoro.balanceOf(distributor.address)).to.equal(0);
            });
        ...
        describe("multiple tree", () => {
            ...
            beforeEach("deploy", async () => {
                ...
                ).to.changeTokenBalance(dextoro, distributor, 2000);
            });
        ...
        describe("larger tree", () => {
            ...
            beforeEach("deploy", async () => {
                ...
                ).to.changeTokenBalance(dextoro, distributor, 100);
            });
        ...
        describe("realistic size tree", () => {
            ...
            beforeEach("deploy", async () => {
                ...
                ).to.changeTokenBalance(dextoro, distributor, 300_000);
            });
    ...
    describe("parseBalanceMap", () => {
        ...
        beforeEach("deploy", async () => {
            ...
            ).to.changeTokenBalance(dextoro, distributor, tokenTotal);
        });
