...
contract TokenDistributor is ITokenDistributor {
    ...
    IDexToro internal immutable dextoro;
    ...
    /// @notice last recorded balance of DTORO in contract
    ...
    function checkpointToken() public override {
        uint tokenBalance = dextoro.balanceOf(address(this));
    ...
    function _claimEpoch(address to, uint epochNumber, uint duration, uint earlyVestFee) internal {
        ...
        dextoro.approve(address(rewardEscrowV2), proportionalFees);
