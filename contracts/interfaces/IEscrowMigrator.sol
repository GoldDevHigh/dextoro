...
interface IEscrowMigrator {
    ...
    /// to spend liquid at least the `toPay` amount of $DTORO
    ...
    /// @notice step 2 - vest all registered entries via the integartor, pulling the early vested DTORO to the beneficiary's address.
