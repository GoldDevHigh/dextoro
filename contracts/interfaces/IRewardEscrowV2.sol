...
interface IRewardEscrowV2 {
    ...
    struct VestingEntry {
        // The amount of DTORO stored in this vesting entry
    ...
    /// @notice Get the amount of escrowed dextoro that is not staked for a given account
    ...
    /// @param _deposit The amount of DTORO to escrow
    /// @param _duration The duration in seconds to lock the DTORO for
    ...
    /// @param _quantity The quantity of DTORO that will be escrowed.
    ...
    ///  Sufficient escrowed DTORO must be unstaked for the transfer to succeed
    ...
    /// @param value The amount of DTORO that was vested
    ...
    /// @param value The amount of DTORO that was escrowed
    ...
    /// @param amountToTreasury The amount of DTORO sent to the treasury
    /// @param amountToNotifier The amount of DTORO sent to the notifier
